...
%% headings
\markboth{\textnormal{\bf \large CLASS_NAME: EXAM_NAME}}%
{\textnormal{\bf \large CLASS_NAME: EXAM_NAME}}
...
\thispagestyle{empty}
{\sf
\textbf{\LARGE{CLASS_NAME}}

\textbf{\large{EXAM_NAME \myDate \hfill Exam ID \myID}}

\vspace*{2cm}

\begin{tabular}{p{4cm} l}
	\textbf{Nome:} & STD_NAME  \\[0.5cm]
	\textbf{Identificador/Cartão:} & STD_ID   \\[0.5cm]
	\textbf{Assinatura:}   \\[1.5cm]
\end{tabular}
